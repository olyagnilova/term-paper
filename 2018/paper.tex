...
\section{Geometric interpretation of random variables}
...
Recall that for any non-random vectors $\vec{a}$ and $\vec{b}$ the angle
...
The analogue for $cos(\vec{a}, \vec{b})$ in the vector space of all the random
...
\]
From the equivalence of $\Corr(X,Y)$ to the $\cos(\vec{a}, \vec{b})$ it
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.4\linewidth]{images/rv_pythagorean.pdf}
...
Recall that for any two vectors the scalar product $\langle \vec{a}, \vec{b} \rangle$
can be interpreted as the length of projected $\vec{b}$ multuplied by the length of $\vec{a}$.
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.4\linewidth]{images/rv_proj.pdf}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.6\linewidth]{images/adams.pdf}
...
Figure~JJJJ illustrates this case: the projection of the estimator falls onto
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.6\linewidth]{images/mse_decomposed.pdf}
...
\begin{figure}[h!]
\center{\includegraphics[width=0.35\linewidth]{images/corr_eq_positive.pdf}}
...
\begin{figure}[h!]
\center{\includegraphics{images/tss_sum_final.pdf}}
...
\begin{figure}
  \center{\includegraphics{images/r_sq_ss.pdf}}
...
\begin{center}
\subfigure[]{
\includegraphics[width=0.45\linewidth]{images/pcorr_theorem_x.pdf}
\label{fig:pcorr_t_x}}
%\hspace{4ex}
\subfigure[]{
\includegraphics[width=0.45\linewidth]{images/pcorr_theorem_y.pdf}
\label{fig:pcorr_t_y}}
...
\begin{center}
\subfigure[]{
\includegraphics[width=0.45\linewidth]{images/pcorr_t_xy.pdf}
\label{fig:pcorr_t_xy}}
%\hspace{4ex}
\subfigure[]{
\includegraphics[width=0.45\linewidth]{images/pcorr_t_lin.pdf}
...
\begin{center}
\subfigure[]{
\includegraphics[width=0.45\linewidth]{images/ttest.pdf}
\label{fig:ttest_3d}}
%\hspace{4ex}
\subfigure[]{
\includegraphics[width=0.45\linewidth]{images/ttest_lin.pdf}
\label{fig:ttest_lin}}
